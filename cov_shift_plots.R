...
models = c(expression(paste(mu, "=0.01, K=1, ", rho, "=1.68", sep='')), expression(paste(mu, "=0.01, K=0, ", rho, "=2.16", sep='')),
           expression(paste(mu, "=0.001, K=5, ", rho, "=7.15", sep='')), expression(paste(mu, "=0.001, K=0, ", rho, "=9.03", sep='')),
           expression(paste(mu, "=0.005, K=1, ", rho, "=3.09", sep='')), expression(paste("Unregularized, ", rho, "=36.58", sep='')),
           expression(paste("Entropy-SGD, ", rho, "=6.82", sep='')), expression(paste("K-FAC, ", rho, "=58.55", sep='')),
           expression(paste("Asym. Valley, ", rho, "=23.28", sep='')), expression(paste("LOBPCG, ", rho, "=1.99", sep='')))
baseline_acc = c(69.70990422, 70.38544616, 70.67201363, 70.8656403, 70.96632617, 71.74169341, 69.68580846, 70.82519384, 70.99459994, 69.4930423446624)
